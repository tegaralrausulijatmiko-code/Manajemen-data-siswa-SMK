...
<div class="page-header">
    <div>
        ...
        <div class="breadcrumb"><a href="<?= base_url('dashboard') ?>">Dashboard</a> / Rekap Absensi Guru</div>
    </div>
...
<div class="stats-grid">
    <?php foreach (['Total' => 'ri-file-list-3-line', 'Hadir' => 'ri-checkbox-circle-line', 'Izin' => 'ri-mail-check-line', 'Sakit' => 'ri-first-aid-kit-line', 'Alpha' => 'ri-close-circle-line', 'Terlambat' => 'ri-time-line'] as $label => $icon): ?>
        <div class="stat-card">
            ...
            <div class="stat-text"><p><?= esc($label) ?></p><h4><?= esc($summary[$label] ?? 0) ?></h4></div>
        </div>
    <?php endforeach; ?>
</div>
...
<div class="card">
    ...
    <form method="get" style="padding:20px;">
        ...
        <div class="form-actions">
            ...
            <a href="<?= base_url('guru/absensi/rekap') ?>" class="btn btn-secondary btn-sm"><i class="ri-refresh-line"></i> Reset</a>
        </div>
    </form>
</div>
...
<div class="card">
    ...
    <div class="table-responsive">
        <table>
            ...
            <tbody>
                <?php if (empty($rekap)): ?>
                    <tr><td colspan="7"><div class="empty-state"><i class="ri-file-search-line"></i><p>Tidak ada data rekap absensi</p></div></td></tr>
                <?php else: ?>
...
echo view('Template/layout', [
    ...
    'subtitle' => 'Rekap absensi kelas yang diajar',
    'content' => $content,
]);
?>
