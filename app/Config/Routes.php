...
$routes->group('', ['filter' => 'auth'], static function ($routes) {
    ...
    $routes->group('', ['filter' => 'role:admin'], static function ($routes) {
        // Absensi Harian Admin — tanpa parameter di URL, kelas via GET ?kelas=
        $routes->get('absensi/harian',                      'Absensi::harian');
        $routes->post('absensi/harian/simpan',              'Absensi::simpanHarian');
    
        // Absensi Mapel Admin — dari halaman jadwal
        ...
        // Landing page absensi → redirect ke harian
